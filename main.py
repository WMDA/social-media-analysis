...
current_data = rd.get_reddit(topics_list, comments_number, reddit_inst=reddit)
...
# Remove duplcates
unique_data = rd.data_to_add(newData=current_data, dataStore=df)
...
comment_data = rd.get_comments(reddit, unique_data.id)
